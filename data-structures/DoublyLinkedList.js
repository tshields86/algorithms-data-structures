...
console.log(dll.contains(3)) // true
console.log(dll.contains(5)) // false
console.log(dll.indexOf(3)) // 2
console.log(dll.indexOf(5)) // -1
dll.reverse()
console.log(dll.toArray()) // [ 4, 3, 2, 1 ]
console.log(dll.get(1)) // 3
dll.set(1, 5)
console.log(dll.get(1)) // 5
console.log(dll.toArray()) // [ 4, 5, 2, 1 ]
console.log(dll.get(1)) // 5
console.log(dll.getFirst()) // 4
console.log(dll.getLast()) // 1
console.log(dll.removeFirst()) // 4
console.log(dll.removeLast()) // 1
console.log(dll.toArray()) // [ 5, 2 ]
dll.add(1, 4)
console.log(dll.size()) // 3
console.log(dll.toArray()) // [ 5, 4, 2 ]
console.log(dll.isEmpty()) // false
dll.clear();
console.log(dll.size()) // 0
